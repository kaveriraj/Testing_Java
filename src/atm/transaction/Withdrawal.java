...
public class Withdrawal extends Transaction
{
   ...
   public boolean validAmount = false;
    ...
    public Message getSpecificsFromCustomer() throws CustomerConsole.Cancelled
    {
        ...
        from = atm.getCustomerConsole().readWithdrawalMenuChoice(
        ...
        while (! validAmount)
        {
        	amount = amountValues [  atm.getCustomerConsole().readWithdrawalAmountMenuChoice(amountMessage + "Amount of cash to withdraw", amountOptions) ];
